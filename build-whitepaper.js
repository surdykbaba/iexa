...
const doc = new Document({
  creator: "IDXA",
  title: "IDXA Whitepaper",
  description: "Interoperable Data eXchange for Africa — Concept & Founding Framework",
  styles: {
  ...
  sections: [
    // ---------- COVER ----------
    {
      ...
      children: [
        ...
        new Paragraph({ alignment: AlignmentType.LEFT, spacing: { after: 80 },
          children: [new TextRun({ text: "IDXA", bold: true, size: 84, color: INDIGO })] }),
        new Paragraph({ spacing: { after: 400 },
          children: [new TextRun({ text: "Interoperable Data eXchange for Africa", size: 32, color: TEAL, bold: true })] }),
    ...
    // ---------- BODY ----------
    {
      ...
      footers: { default: new Footer({ children: [new Paragraph({
        ...
        children: [new TextRun({ text: "IDXA · Interoperable Data eXchange for Africa · v0.1   |   Page ", size: 16, color: MUTED }),
      ...
      children: [
        ...
        rich([
          new TextRun("IDXA — the "),
          new TextRun({ text: "Interoperable Data eXchange for Africa", bold: true }),
        ...
        callout("In one sentence", "IDXA lets any organisation connect once and securely exchange invoices, identity and trusted data with everyone else on the network — without rebuilding integrations, and without surrendering data sovereignty."),
        ...
        // 4. What is IDXA
        h1("4. What IDXA Is"),
        p("IDXA operates on three distinct but connected layers. Keeping them separate is what makes the initiative durable."),
        table([
        ...
        spacer(80),
        callout("Why this separation matters", "The value and defensibility of IDXA is in the standard. Whoever stewards the trusted standard for African data exchange anchors the ecosystem. The Association exists to keep that standard neutral and legitimate; the software exists to make adoption easy."),
        ...
        p("A verification and accreditation framework with a conformance test suite. Every participant is provably who they claim to be; every message is cryptographically signed and auditable. “IDXA-certified” becomes a meaningful badge that guarantees genuine interoperability and security."),
        ...
        // 6. How it works
        h1("6. How It Works"),
        p("Each member runs (or rents) a single secure node — the only component they integrate with. Through IDXA's shared registry and trust services, that one connection reaches every other participant. There are no point-to-point integrations and no central honeypot of data."),
        table([
          ["Step", "Role", "What happens"],
          ["1", "Sender", "A business, bank or agency needs to send data."],
          ["2", "Member Node", "A secure gateway signs, encrypts and routes the message onto IDXA."],
        ...
        table([
          ...
          ["Data (general)", "A general-purpose envelope for any domain — health, logistics, open finance — that adopts the IDXA trust framework.", "On roadmap"],
        ], [2000, 5360, 2000]),

        // 8. Interoperability
        h1("8. Interoperability: Standards & Rails"),
        p("IDXA does not replace the world's standards — it binds them together, so an IDXA invoice can be paid, settled and reported anywhere."),
        ...
        p("IDXA is a neutral, not-for-profit association. Governance is shared across its members; no single company owns the standard. Membership is open in three tiers:"),
        table([
          ...
          ["Provider", "Fintechs, vendors, ERPs", "Run certified nodes; earn the IDXA-certified badge; a voting seat in working groups; commercial use under Apache-2.0."],
        ...
        p("IDXA is as much a movement as a standard. Its purpose is to convene the next generation of African technologists and give them real infrastructure to build. The community is organised around three structures borrowed from the most successful global ecosystems:"),
        ...
        bullet("free training, certification and mentorship that turns students and young developers into the engineers who run Africa's data infrastructure.", "IDXA Academy"),
        ...
        // 12. Call to action
        h1("12. Get Involved"),
        p("IDXA will be built by the people who show up. Whether you write code, run infrastructure or set policy, there is a seat for you."),
...
Packer.toBuffer(doc).then((buf) => {
  fs.writeFileSync("IDXA-Whitepaper.docx", buf);
  console.log("wrote IDXA-Whitepaper.docx");
});
